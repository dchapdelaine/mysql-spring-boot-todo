...
For this example, FTP to deploy the .JAR file built previously on your local machine to Azure App Service.
...
Password:
cd /site/wwwroot
put target/TodoDemo-0.0.1-SNAPSHOT.jar ROOT.jar
...
6. FTP the updated .JAR as before
